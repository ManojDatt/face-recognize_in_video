...
def transparentOverlay(src , overlay , pos=(0,0, 0, 0),scale = 1):
    ...
    """
    overlay = cv2.resize(overlay,(pos[2],pos[3]-50))
...
video_capture = cv2.VideoCapture('test_vid.avi')
...
while True:
    ...
    for (top, right, bottom, left), name in zip(face_locations, face_names):
        ...
        transparentOverlay(frame,overlayImage,(left, top-40, right-left + 25, bottom),1)
